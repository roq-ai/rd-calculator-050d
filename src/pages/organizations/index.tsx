...
export function OrganizationListPage(props: OrganizationListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getOrganizations({
        relations: ['user', 'recurring_deposit.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('recurring_deposit', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'recurring_deposit',
          header: 'Recurring Deposit',
          accessorKey: 'recurring_deposit',
          cell: ({ row: { original: record } }: any) => record?._count?.recurring_deposit,
        }
      : null,
