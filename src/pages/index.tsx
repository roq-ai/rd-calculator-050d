  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless financial planning with RD Calculator - Your ultimate tool for calculating Recurring Deposit online."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1523839699072-5ec088b61a21?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxiYW5raW5nfGVufDB8fHx8MTY5MTI0NzgxMXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless financial planning with RD Calculator - Your ultimate tool for calculating Recurring Deposit online.`}
            </Text>
            <Box
